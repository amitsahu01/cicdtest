/* checksum : f5ad02ed3b7131129f7788c572d8c0c9 */
@cds.external : true
...
entity BUPA.A_AddressEmailAddress {
...
@sap.content.version : '1'
entity BUPA.A_AddressFaxNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
@sap.content.version : '1'
entity BUPA.A_AddressHomePageURL {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
@sap.content.version : '1'
entity BUPA.A_AddressPhoneNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
@sap.content.version : '1'
entity BUPA.A_BPContactToAddress {
  @sap.display.format : 'UpperCase'
  ...
  to_EmailAddress : Association to many BUPA.A_AddressEmailAddress {  };
  @cds.ambiguous : 'missing on condition?'
  to_FaxNumber : Association to many BUPA.A_AddressFaxNumber {  };
  @cds.ambiguous : 'missing on condition?'
  to_MobilePhoneNumber : Association to many BUPA.A_AddressPhoneNumber {  };
  @cds.ambiguous : 'missing on condition?'
  to_PhoneNumber : Association to many BUPA.A_AddressPhoneNumber {  };
  @cds.ambiguous : 'missing on condition?'
  to_URLAddress : Association to many BUPA.A_AddressHomePageURL {  };
};
...
@sap.content.version : '1'
entity BUPA.A_BPContactToFuncAndDept {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
...
@sap.content.version : '1'
entity BUPA.A_BuPaAddressUsage {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
...
@sap.content.version : '1'
entity BUPA.A_BuPaIdentification {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BUPA.A_BusinessPartner {
  ...
  @cds.ambiguous : 'missing on condition?'
  to_BuPaIdentification : Association to many BUPA.A_BuPaIdentification {  };
  @cds.ambiguous : 'missing on condition?'
  to_BuPaIndustry : Association to many BUPA.A_BuPaIndustry {  };
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerAddress : Association to many BUPA.A_BusinessPartnerAddress {  };
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerAddresses : Composition of many BUPA.A_BusinessPartnerAddress;
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerBank : Association to many BUPA.A_BusinessPartnerBank {  };
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerContact : Association to many BUPA.A_BusinessPartnerContact {  };
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerRole : Association to many BUPA.A_BusinessPartnerRole {  };
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerTax : Association to many BUPA.A_BusinessPartnerTaxNumber {  };
  @cds.ambiguous : 'missing on condition?'
  to_Customer : Composition of BUPA.A_Customer on to_Customer.Customer = BusinessPartner;
  @cds.ambiguous : 'missing on condition?'
  to_Supplier : Association to BUPA.A_Supplier {  };
};
...
@sap.label : 'Address'
@sap.content.version : '1'
entity BUPA.A_BusinessPartnerAddress {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
  ...
  @cds.ambiguous : 'missing on condition?'
  to_AddressUsage : Association to many BUPA.A_BuPaAddressUsage {  };
  @cds.ambiguous : 'missing on condition?'
  to_EmailAddress : Association to many BUPA.A_AddressEmailAddress {  };
  @cds.ambiguous : 'missing on condition?'
  to_FaxNumber : Association to many BUPA.A_AddressFaxNumber {  };
...
@sap.label : 'Bank'
@sap.content.version : '1'
entity BUPA.A_BusinessPartnerBank {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.label : 'Contact'
@sap.content.version : '1'
entity BUPA.A_BusinessPartnerContact {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
  ...
  RelationshipCategory : String(6);
  @cds.ambiguous : 'missing on condition?'
  to_ContactAddress : Association to many BUPA.A_BPContactToAddress {  };
  @cds.ambiguous : 'missing on condition?'
  to_ContactRelationship : Association to BUPA.A_BPContactToFuncAndDept {  };
};
...
@sap.label : 'Role'
@sap.content.version : '1'
entity BUPA.A_BusinessPartnerRole {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
entity BUPA.A_BusinessPartnerTaxNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BUPA.A_Customer {
  ...
  County : String(3);
  @cds.ambiguous : 'missing on condition?'
  to_CustomerCompany : Association to many BUPA.A_CustomerCompany {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustomerSalesArea : Association to many BUPA.A_CustomerSalesArea {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustomerTaxGrouping : Association to many BUPA.A_CustomerTaxGrouping {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustomerText : Association to many BUPA.A_CustomerText {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustomerUnloadingPoint : Composition of many BUPA.A_CustomerUnloadingPoint;
};
...
entity BUPA.A_CustomerCompany {
  ...
  CustomerAccountGroup : String(4);
  @cds.ambiguous : 'missing on condition?'
  to_CompanyText : Association to many BUPA.A_CustomerCompanyText {  };
  @cds.ambiguous : 'missing on condition?'
  to_CustomerDunning : Association to many BUPA.A_CustomerDunning {  };
  @cds.ambiguous : 'missing on condition?'
  to_WithHoldingTax : Association to many BUPA.A_CustomerWithHoldingTax {  };
};
...
@sap.content.version : '1'
entity BUPA.A_CustomerCompanyText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  @sap.creatable : 'false'
...
@sap.content.version : '1'
entity BUPA.A_CustomerSalesArea {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  CustomerAccountGroup : String(4);
  @cds.ambiguous : 'missing on condition?'
  to_PartnerFunction : Association to many BUPA.A_CustSalesPartnerFunc {  };
  @cds.ambiguous : 'missing on condition?'
  to_SalesAreaTax : Association to many BUPA.A_CustomerSalesAreaTax {  };
  @cds.ambiguous : 'missing on condition?'
  to_SalesAreaText : Association to many BUPA.A_CustomerSalesAreaText {  };
};
...
@sap.content.version : '1'
entity BUPA.A_CustomerSalesAreaTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
@sap.content.version : '1'
entity BUPA.A_CustomerSalesAreaText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  @sap.creatable : 'false'
...
@sap.content.version : '1'
entity BUPA.A_CustomerTaxGrouping {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  @sap.creatable : 'false'
...
@sap.content.version : '1'
entity BUPA.A_CustomerUnloadingPoint {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
@sap.content.version : '1'
entity BUPA.A_CustomerWithHoldingTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
@sap.content.version : '1'
entity BUPA.A_CustSalesPartnerFunc {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity BUPA.A_Supplier {
  ...
  @cds.ambiguous : 'missing on condition?'
  to_SupplierCompany : Association to many BUPA.A_SupplierCompany {  };
  @cds.ambiguous : 'missing on condition?'
  to_SupplierPurchasingOrg : Association to many BUPA.A_SupplierPurchasingOrg {  };
  @cds.ambiguous : 'missing on condition?'
  to_SupplierText : Association to many BUPA.A_SupplierText {  };
};
...
entity BUPA.A_SupplierCompany {
  ...
  SupplierAccountGroup : String(4);
  @cds.ambiguous : 'missing on condition?'
  to_CompanyText : Association to many BUPA.A_SupplierCompanyText {  };
  @cds.ambiguous : 'missing on condition?'
  to_Supplier : Association to BUPA.A_Supplier {  };
  @cds.ambiguous : 'missing on condition?'
  to_SupplierDunning : Association to many BUPA.A_SupplierDunning {  };
  @cds.ambiguous : 'missing on condition?'
  to_SupplierWithHoldingTax : Association to many BUPA.A_SupplierWithHoldingTax {  };
};
...
@sap.content.version : '1'
entity BUPA.A_SupplierCompanyText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  @sap.creatable : 'false'
...
@sap.content.version : '1'
entity BUPA.A_SupplierPartnerFunc {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
@sap.content.version : '1'
entity BUPA.A_SupplierPurchasingOrg {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  ...
  SupplierAccountGroup : String(4);
  @cds.ambiguous : 'missing on condition?'
  to_PartnerFunction : Association to many BUPA.A_SupplierPartnerFunc {  };
  @cds.ambiguous : 'missing on condition?'
  to_PurchasingOrgText : Association to many BUPA.A_SupplierPurchasingOrgText {  };
};
...
@sap.content.version : '1'
entity BUPA.A_SupplierPurchasingOrgText {
  @sap.creatable : 'false'
  @sap.updatable : 'false'
  key Supplier : String(10) not null;
  key PurchasingOrganization : String(4) not null;
...
@sap.content.version : '1'
entity BUPA.A_SupplierWithHoldingTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
